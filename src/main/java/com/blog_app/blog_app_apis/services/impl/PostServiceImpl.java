...
public class PostServiceImpl implements PostService {
    ...
    public List<PostDto> searchPosts(String keyword) {
        List<Post> postsSearch=this.postRepo.findByTitleContaining(keyword);
        List<PostDto> postDtos=postsSearch.stream().map((post)->this.modelMapper.map(post,PostDto.class)).collect(Collectors.toList());
        return postDtos;
    }
}
